...
const totalIncome = {
	series: [44, 55, 41, 17],
	labels: ["Income", "Download", "Rend", "Views"],
	details: [
		{ label: "Income", value: 23876 },
		{ label: "Download", value: 23876 },
		{ label: "Rend", value: 23876 },
		...
		<div className="flex flex-col gap-4 w-full">
						...
						<CardContent className="flex flex-col gap-2 p-4">
							...
							<div className="w-full h-10 mt-2">
								<Chart
									type="bar"
									height={40}
									options={{ ...barOptions, colors: [stat.color] }}
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
				...
				<Card className="flex flex-col gap-4 p-6">
					...
					<div className="flex items-center justify-between mb-2">
						<Text variant={"body2"}>Release {GLOBAL_CONFIG.appVersion}</Text>
					...
					<ul className="flex flex-col gap-2 mt-2 mb-4">
						{projectTasks.map((task) => (
							<li key={task.label} className="flex items-center gap-2">
								<div className="inline-block w-2 h-2 rounded-full" style={{ background: task.color }} />
