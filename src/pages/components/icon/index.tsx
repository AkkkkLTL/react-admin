	...
	return (
		<>
			...
			<Card title="Local Icons">
				...
				<CardContent>
					<p className="mt-2">
						<code className="text-info">{` <Icon icon="local:ic-dashboard" size={24} color={colorPrimary} />`}</code>
					</p>

					<div className="mt-4 flex gap-4">
						<Icon icon="local:ic-dashboard" size={24} color={themeVars.colors.palette.primary.default} />
						<Icon icon="local:ic-dashboard" size={24} color={themeVars.colors.palette.info.default} />
						<Icon icon="local:ic-dashboard" size={24} color={themeVars.colors.palette.success.default} />
						<Icon icon="local:ic-dashboard" size={24} color={themeVars.colors.palette.warning.default} />
						<Icon icon="local:ic-dashboard" size={24} color={themeVars.colors.palette.error.default} />
					</div>
				</CardContent>
			</Card>
		</>
