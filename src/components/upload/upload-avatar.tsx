...
import Upload, { type UploadChangeParam, type UploadFile } from "antd/es/upload";
...
export function UploadAvatar({ defaultAvatar = "", helperText, ...props }: Props) {
	...
	const renderHelpText = <div className="text-center">{helperText || defaultHeplerText}</div>;
