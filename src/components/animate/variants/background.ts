...
export const varBgColor = (props?: BackgroundType): MotionProps => {
	...
	const duration = props?.durations || 5;
...
export const varBgKenburns = (props?: BackgroundType): VariantsReturnType<"top" | "bottom" | "left" | "right"> => {
	const duration = props?.durations || 5;
...
export const varBgPan = (props?: BackgroundType): VariantsReturnType<"top" | "bottom" | "left" | "right"> => {
