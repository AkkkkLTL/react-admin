...
import CyanBlu from "@/assets/images/background/cyan-blur.png";
...
export default function NoticeButton() {
	...
	const style: CSSProperties = {
		...
		backgroundImage: `url(${CyanBlu}), url(${RedBlur})`,
				...
				<div className="flex-1 min-w-0">
					...
					{notification.fileName && (
						<div className="mt-3 p-3 bg-bg-neutral rounded-lg flex items-center space-x-3">
							<Icon icon={getFileIcon(notification.file)} size={32} />
							<div className="flex-1">
					...
					{notification.files && (
						<div className="mt-3 space-y-2">
							{notification.files.map((file: any) => (
								<div key={file.name} className="p-3 bg-bg-neytral rounded-lg flex items-center space-x-3">
