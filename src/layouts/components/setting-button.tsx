			...
			<SheetContent style={sheetContentBgStyle} className="gap-0" onOpenAutoFocus={(e) => e.preventDefault()}>
				...
				<ScrollArea>
					<div className="flex flex-col gap-6 px-6 py-2">
						...
						{/* 主题布局 */}
						<div className="flex flex-col gap-2">
							<Text variant="subTitle2">{t("sys.settings.layout")}</Text>
							...
							<div className="grid grid-cols-3 gap-4">
								...
								>
									<div className="flex h-full w-5 flex-col gap-1 p-1">
										...
										/>
										<div
											className="h-1 max-2-[12px] shrink-0 rounded opacity-20"
											style={{
												background: layoutBackground(ThemeLayout.VERTICAL),
											}}
										/>
						...
						{/* 主题调色盘 */}
						<div className="flex flex-col gap-2">
							<Text variant="subTitle2">{t("sys.settings.presetThemes")}</Text>
						...
						{/* 页面设置 */}
						<div className="flex flex-col gap-2">
							<Text variant="subTitle2">{t("sys.settings.page")}</Text>
